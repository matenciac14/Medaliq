...
const PHASES = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: 'Control de alta manual desde admin (sin Stripe)', done: true, note: '/admin/activaciones — el admin activa usuarios Free → Pro o Coach. API PATCH /api/admin/users/[id]/plan' },
