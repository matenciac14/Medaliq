...
const PHASES = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: 'Páginas de ayuda por perfil (atleta, coach, admin)', done: false, note: 'Guía de uso del SaaS para cada tipo de usuario' },
      { title: 'Landing page con animaciones y más interacción', done: false, note: 'Scroll reveal, counters animados, mockup interactivo' },
    ],
  },
]
