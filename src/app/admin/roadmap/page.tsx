...
const PHASES = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: 'Tabs Resumen/Plan/Progreso/Nutrición → datos reales de DB', done: false, note: 'Actualmente usa mockAthletes. Conectar a: HealthProfile, TrainingPlan, WeeklyCheckIn, DailyLog' },
  ...
  },
  {
    ...
    borderColor: '#d8b4fe',
    items: [
      { title: 'Tabs coach Resumen/Plan/Progreso/Nutrición → DB real', done: false, note: 'Reemplazar mockAthletes por queries reales: HealthProfile, TrainingPlan, CheckIn, DailyLog, NutritionPlan' },
      { title: 'Rate limiting en APIs críticas', done: false, note: '/api/auth/register, /api/onboarding/generate, /api/ai/chat — usar upstash/ratelimit o middleware propio' },
      { title: 'Páginas de error custom (404, 500)', done: false, note: 'src/app/not-found.tsx + error.tsx con diseño Medaliq' },
      { title: 'Google OAuth con dominio real', done: false, note: 'Credenciales en Google Cloud Console con medaliq.com como authorized origin' },
      ...
      { title: 'Hardening: validación de inputs en todas las APIs', done: false, note: 'Zod schemas en rutas POST/PATCH — actualmente confía demasiado en el cliente' },
      { title: 'Prisma connection pooling (PgBouncer)', done: false, note: '?pgbouncer=true en DATABASE_URL para evitar connection limit en Vercel serverless' },
    ],
  },
]
